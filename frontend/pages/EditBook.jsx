...
const EditBook = () => {
  ...
  return (
    <div className="p-8 bg-[#f0e6d2] min-h-screen flex flex-col items-center">
      <h1 className="text-4xl font-semibold text-[#3e2a47] mb-8">Edit Book</h1>

      <form onSubmit={handleEditBook} className="w-full max-w-md bg-white rounded-lg shadow-xl p-6">
